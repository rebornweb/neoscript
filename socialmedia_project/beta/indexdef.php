...
/*
 ...
 mcrypt_decrypt(MCRYPT_RIJNDAEL_256, $key, $rijndael256, MCRYPT_MODE_ECB, $iv);
*/
...
if($_POST['submit']=='Login')
{
	...
	$username = mysqli_real_escape_string($connection,$_POST['username']);
	 $loginPass =  mysqli_real_escape_string($connection,$_POST['loginPassword']);
			
			//Decrypted Password
	//$loginPassDcrypt = mcrypt_decrypt(MCRYPT_RIJNDAEL_256, $key, $loginPass, MCRYPT_MODE_ECB, $iv);
...
$sql= "SELECT id,usr,pass,hash FROM tz_members WHERE usr='".$username."' AND pass='".str_rot13($_POST['loginPassword'])."'";
